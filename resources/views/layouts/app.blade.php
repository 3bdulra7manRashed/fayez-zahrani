...
<head>
    ...
    <title>@yield('title', $title ?? 'مكتبة الشيخ فايز بن سعيد الزهراني')</title>
    <meta name="description" content="@yield('meta_description', $meta_description ?? $description ?? 'صفحة رسمية تفاعلية تجد فيها مؤلفات الشيخ فايز بن سعيد الزهراني، للقراءة والتحميل المباشر.')">
    ...
    <meta property="og:title" content="@yield('og_title', $og_title ?? $title ?? 'مكتبة الشيخ فايز بن سعيد الزهراني')">
    <meta property="og:description" content="@yield('og_description', $og_description ?? $meta_description ?? $description ?? 'صفحة رسمية تفاعلية تجد فيها مؤلفات الشيخ فايز بن سعيد الزهراني، للقراءة والتحميل المباشر.')">
    ...
    <meta name="twitter:title" content="@yield('og_title', $og_title ?? $title ?? 'مكتبة الشيخ فايز بن سعيد الزهراني')">
    <meta name="twitter:description" content="@yield('og_description', $og_description ?? $meta_description ?? $description ?? 'صفحة رسمية تفاعلية تجد فيها مؤلفات الشيخ فايز بن سعيد الزهراني، للقراءة والتحميل المباشر.')">
